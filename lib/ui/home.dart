...
class _HomeState extends State<Home> {
  ...
  void fetchWeatherData() async {
    final queryParameters = {"q": "21.028511,105.804817"};
    var weatherResult = await http.get(
      Uri.https('weatherapi-com.p.rapidapi.com', 'current.json', queryParameters),
      headers: {
        "X-RapidAPI-Key": "60a0c103c2msh656362e6b16e1bbp14f2e3jsn9bd44db1a19d",
        "X-RapidAPI-Host": "weatherapi-com.p.rapidapi.com",
      },
    );
    var result = json.decode(weatherResult.body);
    var consolidatedWeather = result['current'];
    ...
    setState(() {
      ...
      // }
      //The index 0 refer to the first entry which is the current day. The next day will be index 1, second day index 2 etc...
      temperature = consolidatedWeather['temp_c'].round();
      weatherStateName = 'clear';
      humidity = consolidatedWeather['humidity'].round();
      windSpeed = consolidatedWeather['wind_kph'].round();
      maxTemp = 0;
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: size.width,
              height: 200,
              decoration: BoxDecoration(color: myConstants.primaryColor, borderRadius: BorderRadius.circular(15), boxShadow: [
                BoxShadow(
            ...
            Row(
              ...
              children: [
                ...
                Text(
                  'Next 7 Days',
                  style: TextStyle(fontWeight: FontWeight.w600, fontSize: 18, color: myConstants.primaryColor),
                ),
              ],
            ),
            const SizedBox(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          ...
                          width: 80,
                          decoration: BoxDecoration(color: selectedDay == today ? myConstants.primaryColor : Colors.white, borderRadius: const BorderRadius.all(Radius.circular(10)), boxShadow: [
                            BoxShadow(
